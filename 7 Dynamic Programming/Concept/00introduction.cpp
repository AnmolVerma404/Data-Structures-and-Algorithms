...
Top Down can start from 0th index or nth index the logic is we are calling function which will go down to the base case,
and will return the solution from down. Therefore it's called top-Down. And bottom up is called this because we are going from bottom and that can be 0th or nth index!!!.
